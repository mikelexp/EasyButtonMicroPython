# lib/button.py
# MicroPython port of EasyButton (https://github.com/evert-arias/EasyButton)
#
# Usage:
#   btn = Button(0)                        # GP0, active-low with pull-up (default)
#   btn.on_pressed(cb)                     # short press: fires on release if not held
#   btn.on_pressed_for(2000, cb)           # long press: fires once when held >= 2s
#   btn.on_sequence(3, 1000, cb)           # 3 presses within 1 second
#
#   while True:
#       btn.read()                         # call every loop iteration
